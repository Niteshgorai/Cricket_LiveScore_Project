package com.crick.app.CricketInformer.services.impl;

import com.crick.app.CricketInformer.entities.Match;
import com.crick.app.CricketInformer.repositories.MatchRepo;
...
public class MatchServiceImpl implements MatchService {
    ...
    public MatchServiceImpl(MatchRepo matchRepo) {
        ...
        System.out.println("MatchRepo initialized: " + (this.matchRepo != null));
    }

//    Find History all matches in our database
    @Override
...
//                try{
                ...
                matches.add(match1);
//                } catch (Exception ex) {
//                    // Log any exceptions that occur during match parsing
//                    ex.printStackTrace();
//                }
